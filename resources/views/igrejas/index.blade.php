        ...
        $.ajax({
            ...
            success: function (data) {
                // handle success response
                    ...
                    Toast.fire({
                        type: 'success',
                        title: (data.message) ? data.message : 'Igreja atualizada com sucesso!'
                    });
            },
            error: function (data) {
                // handle error response
...
$(document).on('click', '.delete', function (e) {
  ...
  html: 'Ao confirmar esta ação, a igreja <b>' + row.attr('data-nome') + '</b> será <b>excluída permanentemente</b>',
  icon: 'warning',
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Sobre:</strong>
                                <textarea class="form-control" name="sobre" id="sobre" cols="30" rows="10" placeholder="Insira aqui uma breve descrição da igreja"></textarea>
                            </div>
                        </div>
